                    ...
                    <div class="form-items">
                        ...
                        <form method="post" action="<?php echo base_url();?>login/auth/">
                            ...
                            <div class="form-button">
                                ...
                                <button id="submit" type="submit" class="ibtn"><?php echo getEduAppGTLang('login');?></button>
                                <a href="<?php echo base_url();?>forgot_password/"><?php echo getEduAppGTLang('forgot_my_password');?></a>
